...
public class Manager{
	...
	public List<Prenotazione> trovaperdata(@PathVariable Integer id,@RequestParam (required=true) String data){
		return archivioPrenotazioni.trovaPrenotazioneInData(id,data);
	}
