...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void ricalcolaTotale(){
    ...
    // pulisce il vettore dei mesi fioriti
  ...
  Widget generaListaDisponibili(BuildContext context, int index) {
    ...
    return ListTile(
      ...
      onTap: (){
        setState(() {
          descrizionePianta = listaDisponibili[index].descrizione;
        });
      },
      onLongPress: (){
        setState(() {
  ...
  @override
  Widget build(BuildContext context) {
    return Scaffold(appBar: AppBar(backgroundColor: Theme.of(context).colorScheme.inversePrimary,title: const Text("Vivaio")), body:Material(color:Colors.pink[300],child:Container(child: Column(children: <Widget>[
          Row(
