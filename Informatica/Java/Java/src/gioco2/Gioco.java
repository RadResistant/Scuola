...
public class Gioco extends Application {
	...
	public void start(Stage finestra) throws Exception {
		...
		KeyFrame kfBullet = new KeyFrame(Duration.millis(1),e -> etlBullet());
		tlBullet[bullet] = new Timeline(kfBullet);
		tlBullet[bullet].setCycleCount(Timeline.INDEFINITE);
